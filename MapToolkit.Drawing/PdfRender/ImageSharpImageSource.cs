...
namespace Pmad.Cartography.Drawing.PdfRender
{
    public class ImageSharpImageSource<TPixel> : ImageSource where TPixel : unmanaged, IPixel<TPixel>
    {
        ...
        protected override IImageSource FromBinaryImpl(string name, Func<byte[]> imageSource, int? quality = 75)
        {
            ...
            return new ImageSharpImageSourceImpl<TPixel>(name, image, quality ?? 75, imageInfo.Metadata.DecodedImageFormat is PngFormat);
        }
        ...
        protected override IImageSource FromFileImpl(string path, int? quality = 75)
        {
            ...
            return new ImageSharpImageSourceImpl<TPixel>(path, image, quality ?? 75, imageInfo.Metadata.DecodedImageFormat is PngFormat);
        }
