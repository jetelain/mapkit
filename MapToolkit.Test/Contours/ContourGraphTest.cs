...
namespace Pmad.Cartography.Test.Contours
{
    public class ContourGraphTest
    {
        ...
        public void Add_SinglePoint()
        {
            ...
            Assert.Equal("LINESTRING (0.5 0.75, 0.25 0.5, 0.5 0.25, 0.75 0.5, 0.5 0.75)", new Path<double,Vector2D>(line.Points.AsSpan<CoordinatesValue,Vector2D>().ToReadOnlyArray()).ToString());
